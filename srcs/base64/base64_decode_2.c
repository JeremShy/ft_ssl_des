...
/*
	...
	** If a buf is provided, it must be able to countain at least the size of the decoded output (input_size * 3 / 4).
*/
...
void			decode_n_store_four_chars(char enc_buff[4], t_params_base64 *params, uint8_t *buf, int *j)
{
	if (enc_buff[2] == '=')
	{
